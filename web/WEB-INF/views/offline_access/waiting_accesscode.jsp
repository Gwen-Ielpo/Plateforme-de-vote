...
<div class="container">
    <div class="row row-offcanvas row-offcanvas-left">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <p> Mais avant de pouvoir vous connecter, il va falloir activer votre compte en cliquant sur le lien contenu dans le mail qui vient de vous être envoyé ! </p>
        </div>
